...
function tieneEmail(usuario) {
  ...
  //return usuario.hasOwnProperty(email)? true : false;
...
function tienePropiedad(objeto, propiedad) {
  ...
  if(objeto[propiedad]){ //se usa con corchetes y sin comillas y sin dot notation porque es el valor del parametro
    //if(objeto.hasOwnProperty(propiedad)) puede ser asi tambien
    return true;
  }
  return false;
...
function agregarMetodoCalculoDescuento(producto) {
  ...
  producto.calcularPrecioDescuento = function(){
    desc = precio.producto - (producto.precio * producto.porcentajeDeDescuento);
    return desc;
  }
  return producto;
